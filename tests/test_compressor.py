...
class TestCompressor(unittest.TestCase):
    ...
    def test_repr_method(self):
        ...
        compressor.power_consumption_value = 0.25
        repr_str = repr(compressor)
        
        self.assertIn("Compressor", repr_str)
        self.assertIn("Index=5", repr_str)
        self.assertIn("Ratio=1.40", repr_str)
        self.assertIn("Power=0.25", repr_str)
