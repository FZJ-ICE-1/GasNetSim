...
#     Last change on 12/22/24, 9:56 PM
...
def test_heating_value_100iter():
    ...
    for _ in range(100):
        ...
        expected_heating_value = gas_mixture.CalculateHeatingValue(
            comp=gerg_composition, hhv=True, parameter="volume"
        )
...
def test_pressure_gerg_100iter():
    ...
    for iter in range(100):
        ...
        # d = 10
        _, _, d = DensityGERG_numba(
            P=gas_mixture.P, T=gas_mixture.T, x=random_b, iFlag=0
        )
...
def test_reducing_parameters_gerg_100iter():
    ...
    for _ in range(100):
        ...
        assert_almost_equal(
            actual_reducingparametersgerg, expected_reducingparametersgerg
        )
...
def test_pseudo_critical_point_gerg_100iter():
    ...
    for _ in range(100):
        ...
        assert_allclose(
            actual_pseudocriticalpointgerg, expected_pseudocriticalpointgerg
        )
