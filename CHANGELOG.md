...
### Changed
- Add modular `Problem`/`Solver` interfaces for simulation internals
- Add an optional `staggered` coupling strategy for composition-sensitive cases (`coupling_strategy="staggered"`)
